...
export class Items1700583526580 implements MigrationInterface {
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TABLE "temporary_item_img_url" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "item_img_url" varchar NOT NULL, "is_main_img" boolean NOT NULL, "itemId" integer, CONSTRAINT "FK_705f1a9ef42711831f9a8b67cc9" FOREIGN KEY ("itemId") REFERENCES "item" ("id"))`,
    );
    await queryRunner.query(
